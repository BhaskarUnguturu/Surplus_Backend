...
import com.surplus.fwm.model.VerificationToken;
import com.surplus.fwm.repository.VerificationTokenRepository;
...
public class VerificationTokenServiceImpl implements IVerificationTokenService {
	...
	public void sendVerificationToken(User user) {
		new Thread(() -> {
			String subject = "surplus Account verification";
	...
	public String createEmailBody(String name, String url) {
		final String body = "<html><body><h3>Hello " + name.toUpperCase() + "</h3>"
				...
				+ "<a href=\"" + url + "\">Clicking Here </a>" + "<br><br><p>Kind Regards,<br>Team surplus</body></html>";
		return body;
	}
